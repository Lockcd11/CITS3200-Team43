...
if __name__ == "__main__":
    ...
    while depth > 1:
        ...
        depth=depth-1
        print('depthup')
    with open('app/static/csvs/relationships.csv', 'w', newline='') as out:
